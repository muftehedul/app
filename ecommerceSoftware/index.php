        ...
        <nav class="navbar navbar-expand-lg navbar-dark mdb-color lighten-3 mt-3 mb-5">
          ...
          <div class="collapse navbar-collapse" id="basicExampleNav">
            ...
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item active">
                <button name="category" value="All" class="nav-link bg-transparent" style="border: none; padding: 15px 32px;" href="#">All
                  <span class="sr-only">(current)</span></button>
              </li>
              <li class="nav-item">
                <button name="category" value="fashion" class="nav-link bg-transparent" style="border: none; padding: 15px 32px;" href="#">Fashion</button>
              </li>
              <li class="nav-item">
                <button name="category" value="cosmetics" class="nav-link bg-transparent" style="border: none; padding: 15px 32px;" href="#">Cosmetics</button>
              </li>
              <li class="nav-item">
                <button name="category" value="gadgets" class="nav-link bg-transparent" style="border: none; padding: 15px 32px;" href="#">Electronical Gadgets</button>                
              </li>
        ...
        <section class="text-center mb-4">
          ...
          <div class="row wow fadeIn">
            ...
            if (isset($_POST["category"])&&$_POST["category"]!="All") {
              ...
              $query = "SELECT * FROM shopingCart  WHERE category = '$category' ORDER BY id DESC;";
            }else{
              $query = "SELECT * FROM shopingCart ORDER BY id DESC;";
            }
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              ...
              <div class="card">
                ...
                <div class="view overlay">
                  <img src="data:image/jpeg;base64,'.base64_encode($row['images'] ).'" class="card-img-top"
                  alt="" height="210" width="243">
                  <a>
                ...
                <div class="card-body text-center">
                  ...
                  <h5>
                  <strong>
                  <a href="" class="dark-grey-text">'.$row['description'] .'<span class="badge badge-pill danger-color">NEW</span>
                </a>
                </strong>
                </h5>
                <h4 class="font-weight-bold blue-text">
                <strong>'.$row['price'] .' tk</strong>
                </h4>
                <form method="POST" action="productDetails.php">
                  <button type="submit" name="cartId" value="'.$row['id'] .'" class="btn btn-light">View Product</button>
                </form>
                <form method="POST" action="addToCart.php">
                  <button type="submit" name="cartId" value="'.$row['id'] .'" class="btn btn-info">Add to Cart</button>
                </form>
              </div>
              <!--Card content-->
            </div>
